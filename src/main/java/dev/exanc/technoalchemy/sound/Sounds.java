package dev.exanc.technoalchemy.sound;
...
public class Sounds {
  ...
  public static final DeferredRegister<SoundEvent> SOUND_EVENTS = DeferredRegister.create(
    BuiltInRegistries.SOUND_EVENT, TechnoAlchemical.MOD_ID
  );
  ...
  public static final DeferredSoundType MAGIC_BLOCK_SOUNDS = new DeferredSoundType(
    1, 1, MAGIC_BLOCK_BREAK, MAGIC_BLOCK_STEP, MAGIC_BLOCK_PLACE, MAGIC_BLOCK_HIT, MAGIC_BLOCK_FALL
  );

  private static Supplier<SoundEvent> registerSoundEvent(String name) {
    ResourceLocation location = ResourceLocation.fromNamespaceAndPath(TechnoAlchemical.MOD_ID, name);
